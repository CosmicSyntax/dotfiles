...
PopupWindow {
    ...
    Rectangle {
        ...
        Column {
            ...
            // RESTORED: Power Profiles Repeater
            Row {
                spacing: 15
            ...
            ListView {
                ...
                // CORRECTED: History Delegate (No required properties)
                delegate: Rectangle {
            ...
            Row {
                ...
                Repeater {
                    model: [
                        ...
                        { icon: "󰐥", action: "systemctl poweroff", color: "#bf616a" } // Red accent for shutdown
                    ]
